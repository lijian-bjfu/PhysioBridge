...
from src.utils.paths import RECORDER_DATA_DIR, MIRROR_DATA_DIR, PROCESSED_DATA_DIR
...
MAIN_ROOT   = RECORDER_DATA_DIR
MIRROR_ROOT = MIRROR_DATA_DIR
...
def main():
    ...
    # 写报告
    out_path = PROCESSED_DATA_DIR / "compare_report.txt"
    with out_path.open("w", encoding="utf-8") as f:
        f.write(f"main : {PROCESSED_DATA_DIR}\nmirror: {mirror_dir}\n\n")
        f.write("[1] 流覆盖一致性\n")
